...
# the fully-qualified `from wpi_verl_plugin.proto import wpi_pb2`.
sed -i.bak 's/^import wpi_pb2 as wpi__pb2$/from wpi_verl_plugin.proto import wpi_pb2 as wpi__pb2/' \
